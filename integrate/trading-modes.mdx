...
The `mode` query parameter on [`GET /quote`](/api-reference/delta-v2/quote) tells Velora which execution path to consider: `DELTA`, `MARKET`, or `ALL`.
...
| MEV exposure | Private auction — solver competition | Public mempool — sandwichable |
