...
Each guide walks one product end to end over plain HTTP, then links to the API reference for full schemas.
...
<CardGroup cols={2}>
  <Card title="Delta API examples" icon="bolt" href="/delta/examples/typescript">
    `GET /quote?mode=DELTA` for a gasless intent quote. TypeScript, Go, Python, Rust.
  </Card>
