...
You can avoid this round-trip by passing `permit` or `permit2` data in the build call. See [Permit & Permit2 patterns](/guides/permit-and-permit2-patterns).
...
- [Permit & Permit2 patterns](/guides/permit-and-permit2-patterns) — skip the separate approve transaction.
