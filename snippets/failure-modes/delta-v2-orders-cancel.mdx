...
|---|---|---|
| 400 `Invalid signature`                                          | Cancellation EIP-712 typed data assembled wrong (wrong chainId or wrong domain)               | Sign the relayer's cancel payload — the SDK's `signCancelDeltaOrderRequestV2` handles this for you |
