...
<Note>
A design-token theming API (brand colors, fonts, border radius) is not available yet. If that's a blocker for your integration, contact [support@velora.xyz](mailto:support@velora.xyz).
</Note>
