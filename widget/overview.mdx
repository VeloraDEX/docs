...
<CardGroup cols={2}>
  <Card title="Multi-chain swaps" icon="arrows-left-right">
    Ethereum, Polygon, BNB, Avalanche, Arbitrum, Optimism, Base, Gnosis,
    Unichain — same-chain and crosschain.
  </Card>
...
- **Quotes** come from the same [Market API](/api-reference/market/overview) and [Delta API](/api-reference/delta-v2/overview) you'd hit from the SDK — no separate widget backend.
