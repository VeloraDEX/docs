...
- `sdk.deltaV2` is the **recommended** path. Full Delta V2 lifecycle: `getDeltaPrice`, `submitDeltaOrder`, build/sign/post split, `getDeltaOrders` (paginated), `cancelDeltaOrders`, plus reused approve/preSign.
...
- `sdk.otc` exposes the AugustusRFQ maker/taker orders used for OTC; see [OTC](/sdk/products/otc).
