...
- `sdk.deltaV2` — **recommended.** Full Delta V2 lifecycle: `getDeltaPriceV2`, `submitDeltaOrderV2`, build/sign/post split, `getDeltaOrdersV2` (paginated), `cancelDeltaOrdersV2`, plus reused approve/preSign.
