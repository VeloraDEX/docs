...
Full signatures, parameter shapes, and return types are generated from source into the [SDK typedoc reference](https://github.com/VeloraDEX/sdk/tree/main/docs/md).
