...
<Steps>
  ...
  <Step title="Maker signs and posts the order">
    The maker builds an order naming the intended `taker`, signs the EIP-712 typed data, and posts it: `sdk.otcOrders.submitOTCOrder({ ...terms, taker })`. No gas, no transaction.
  </Step>
