...
keywords: ["sdk", "simple", "full", "partial", "composable", "tree-shaking"]
---
...
Every variant ultimately calls the same `construct*` factories under [`@velora-dex/sdk` `src/methods/`](https://github.com/VeloraDEX/sdk/tree/main/src/methods). That means:
...
<CardGroup cols={3}>
  ...
  <Card title="Composable SDK" icon="cubes" href="/sdk/composable-sdk">
