...
[Simple SDK](/sdk/simple-sdk) builds both for you from a single options object. [Composable](/sdk/composable-sdk) and [Partial](/sdk/partial-sdk) SDKs take them as constructor arguments.
...
- [Composable SDK](/sdk/composable-sdk) — takes the caller and fetcher you construct here.
