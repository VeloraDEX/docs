...
|---|---|---|---|
| "Swap token A to token B" | `mode=ALL` | Call [`GET /quote`](/api-reference/market/quote) with `mode=ALL`, `chainId`, token addresses, amount, slippage, and the app or project `partner` value. | Velora can choose the best available path. |
