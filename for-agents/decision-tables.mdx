...
|---|---|---|---|
| "Swap token A to token B" | `mode=ALL` | Call [`GET /quote`](/api-reference/quote/quote) with `mode=ALL`, `chainId`, token addresses, amount, slippage, and the app or project `partner` value. | Velora can choose the best available path. |
...
<CardGroup cols={2}>
  ...
  <Card title="Delta quote" icon="code" href="/api-reference/quote/quote">
