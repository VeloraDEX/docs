...
Requirements:
- Use the Velora Delta REST API at `https://api.velora.xyz`. Endpoints: `GET /quote` (with `mode=DELTA`), `POST /delta/orders/build`, `POST /delta/orders`, `GET /delta/orders/:id`.
