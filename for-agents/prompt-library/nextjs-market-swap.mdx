...
<Tip>
  Want gasless + MEV-protected fills instead? Start with [`nextjs-delta-swap`](/for-agents/prompt-library/nextjs-delta-swap), or call `GET /quote?mode=ALL` and let Velora pick the path — see [Trading modes](/integrate/trading-modes).
</Tip>
