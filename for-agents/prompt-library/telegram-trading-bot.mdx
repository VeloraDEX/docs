...
- Quote with `mode=ALL` at `GET https://api.velora.xyz/quote`. Always set `partner` to the bot's partner identifier (`my-app-name` is only a placeholder). Native ETH placeholder: `0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE`.
