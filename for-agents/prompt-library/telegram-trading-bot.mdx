...
- Quote with `mode=ALL` at `GET https://api.velora.xyz/quote`. Always pass `partner=my-app-name` (replace with the bot's `partner` identifier). Native ETH placeholder: `0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE`.
