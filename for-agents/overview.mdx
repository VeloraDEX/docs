...
- Use [Limit orders](/overview/trading-concepts/limit-orders) and [TWAP](/overview/trading-concepts/twap) when the user wants delayed execution, target prices, or time-sliced trades. For API-based agents, build these flows through `/delta/v2/prices`, `/delta/v2/orders/build`, `/delta/v2/orders`, and Delta order read endpoints.
