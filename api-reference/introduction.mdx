---
title: "Introduction"
description: "The Velora REST API: gasless Swap (Delta) intents, Market aggregation, and OTC orders across 10+ EVM chains over plain HTTPS, with no key required to start."
keywords: ["api", "reference", "openapi", "velora"]
---

The Velora REST API is best execution as plain HTTPS: gasless intents, DEX aggregation, and on-chain OTC across 10+ EVM chains. It works from any language and stack, with no SDK to install and no key to get started.
