---
title: "Introduction"
description: "The Velora REST API — gasless Swap (Delta) intents, Market aggregation, and OTC orders across 10+ EVM chains. Plain HTTPS, language-agnostic, no key to start."
keywords: ["api", "reference", "openapi", "velora"]
---

The Velora REST API is best execution as plain HTTPS — gasless intents, DEX aggregation, and on-chain OTC across 10+ EVM chains. Any language, any stack, any wallet. No SDK to install, and no key to get started.
...
<CardGroup cols={3}>
  <Card title="Swap API" icon="bolt" href="/api-reference/delta-v2/overview">
    **Delta** intents — gasless, MEV-protected swaps and signed orders, same-chain or crosschain. One signature.
  </Card>
  <Card title="Market API" icon="chart-line" href="/api-reference/market/overview">
    Best price across every DEX and AMM, returned as ready-to-send calldata.
  </Card>
  <Card title="OTC API" icon="handshake" href="/api-reference/rfq/overview">
    Fungible-token over-the-counter orders, with optional partial fills.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/overview/quickstart">
    First quote in 60 seconds — cURL, SDK, or Widget.
  </Card>
